...
def recreatedb(bool):
    ...
    mycursor.execute("CREATE TABLE COMPLAINTS (CONTACTNUMBER VARCHAR(12), SUBJECT VARCHAR(100), MESSAGE VARCHAR(300), CNUMBER int NOT NULL AUTO_INCREMENT, PRIMARY KEY(CNUMBER), PID int, FOREIGN KEY (PID) REFERENCES PATIENTS(PID) )")
